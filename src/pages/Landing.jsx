...
import {
    Rocket, ShieldCheck, Smartphone, Palette, ArrowRight, LayoutDashboard,
    Utensils, Warehouse, Calculator, TrendingUp, Clock, Zap, Users,
    Star, ChevronLeft, ChevronRight, Sparkles, BarChart3, CheckCircle2
} from "lucide-react";
    ...
    const features = [
        {
            ...
            description: "Efficiently manage meal planning and distribution for large-scale events like DevFest.",
        },
        {
            icon: <Warehouse className="w-6 h-6" />,
            title: "Stock Control",
            description: "Real-time stock tracking and intelligent reorder recommendations based on demand.",
        },
        {
            icon: <Calculator className="w-6 h-6" />,
            title: "Demand Prediction",
            description: "AI-powered forecasting to minimize waste and ensure everyone gets fed.",
        },
        {
            icon: <ShieldCheck className="w-6 h-6" />,
            title: "Secure Access",
            description: "Role-based access control for kitchen staff, admins, and distribution teams.",
        },
    ];

    const stats = [
        { label: "Meals Served", value: 10000, suffix: "+", icon: <Utensils className="w-8 h-8" /> },
        { label: "On-Time Delivery", value: 99.8, suffix: "%", icon: <Clock className="w-8 h-8" /> },
        { label: "Waste Reduction", value: 85, suffix: "%", icon: <TrendingUp className="w-8 h-8" /> },
        { label: "Active Users", value: 500, suffix: "+", icon: <Users className="w-8 h-8" /> },
    ];
    ...
    const testimonials = [
        {
            ...
            company: "DevFest Lagos 2024",
            image: "/images/avatar-1.png",
            quote: "This platform transformed how we handle meal distribution. The AI forecasting is incredibly accurate, and we've reduced food waste by over 80%!",
            rating: 5
        },
        {
            name: "Michael Chen",
            ...
            quote: "Managing 2,000+ attendees was seamless. Real-time stock tracking meant we never ran out, and the dashboard gave us complete visibility.",
            rating: 5
        },
        {
            ...
            quote: "The best meal management system we've used. Intuitive, powerful, and the demand predictions have saved us thousands in food costs.",
            rating: 5
        },
    ];
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-border/40 px-6 py-4">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xl font-bold tracking-tight">DevFest <span className="text-primary">Eats</span></span>
                    </div>
                    <Button
                        variant="ghost"
                        size="sm"
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-muted-foreground mb-8 max-w-lg leading-relaxed">
                            The ultimate meal distribution and stock management platform designed for massive events. Smart, seamless, and efficient.
                        </p>
                    ...
                    >
                        ...
                        {/* Hero Image */}
                        <div className="relative overflow-hidden animate-float max-h-[500px] rounded-3xl">
                            <img
                                src="/images/hero-illustration.png"
                                alt="AI-Powered Meal Management"
                                className="w-full h-full object-contain max-h-[500px] rounded-3xl"
                            />
                        </div>
                        ...
                        >
                            ...
                            <div>
                                <div className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">System Status</div>
                        ...
                        >
                            ...
                            <div>
                                <div className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">AI Powered</div>
            ...
            <section className="py-20 px-6 sm:px-12 bg-muted/20 relative">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mt-4">Built for modern organizers</h2>
                        <p className="text-muted-foreground text-lg mt-4 max-w-2xl mx-auto">
                            Everything you need to manage meals at scale, powered by cutting-edge AI technology.
                        </p>
                    </div>
                        ...
                        {features.map((feature, index) => (
                            ...
                            >
                                <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center mb-6 group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
                                    {React.cloneElement(feature.icon, { className: "w-6 h-6 text-primary transition-colors duration-300 group-hover:text-white" })}
                                </div>
            ...
            <section className="py-20 px-6 sm:px-12 relative">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mt-4">Loved by event organizers</h2>
                        ...
                        >
                            <div className="flex items-start gap-6 mb-6">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-primary font-semibold">{testimonials[currentTestimonial].company}</p>
                                </div>
                            ...
                            <div className="flex items-center gap-2">
                                {testimonials.map((_, index) => (
                                    <button
                                        ...
                                        className={`w-2 h-2 rounded-full transition-all ${index === currentTestimonial ? "bg-primary w-8" : "bg-muted-foreground/30"
                                            }`}
            ...
            <section className="py-20 px-6 sm:px-12">
                ...
                >
                    ...
                    <p className="text-white/90 text-lg sm:text-xl mb-12 max-w-2xl mx-auto relative z-10 font-medium">
                        Stop guessing demand. Start delivering excellence with our data-driven meal management ecosystem.
                    </p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        <div className="col-span-1 md:col-span-2">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <span className="font-bold tracking-tight">DevFest Eats</span>
                            </div>
                            <p className="text-muted-foreground text-sm max-w-md leading-relaxed">
                                The ultimate AI-powered meal management platform for events at scale. Reduce waste, optimize planning, and deliver excellence.
                            </p>
                        </div>
                        <div>
                    ...
                    <div className="pt-8 border-t border-border/40 flex flex-col md:flex-row justify-between items-center gap-4">
                        <div className="text-muted-foreground text-sm font-medium">
                            © 2025 DevFest Eats. Crafted with React & Framer Motion.
                        </div>
